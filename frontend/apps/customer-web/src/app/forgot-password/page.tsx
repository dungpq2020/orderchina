...
export default function ForgotPasswordPage() {
  return (
    <AuthBackground>
      <div className="relative w-full max-w-sm overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-2xl shadow-zinc-900/10 dark:border-zinc-800 dark:bg-zinc-900 dark:shadow-black/50">
        <div className="h-1.5 w-full bg-gradient-to-r from-blue-600 to-orange-500" />
        <div className="space-y-4 p-8 text-center">
          <h1 className="text-lg font-semibold text-zinc-900 dark:text-zinc-50">Quên mật khẩu</h1>
