...
namespace OrderChina.Shared.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260807065555_AddCartShopServices")]
    partial class AddCartShopServices
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderChina.Shared.Domain.Orders.MainOrder", b =>
                {
                    ...
                    b.Property<decimal>("HomeDeliveryFeeAmount")
                        .HasColumnType("numeric")
                        .HasColumnName("home_delivery_fee_amount");
                    ...
                    b.Property<decimal>("PackagingFeeAmount")
                        .HasColumnType("numeric")
                        .HasColumnName("packaging_fee_amount");
            ...
            modelBuilder.Entity("OrderChina.Shared.Domain.Orders.MainOrderPaymentHistory", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_main_order_payment_histories");

                    b.HasIndex("MainOrderId")
                        .HasDatabaseName("ix_main_order_payment_histories_main_order_id");

                    b.ToTable("main_order_payment_histories", (string)null);
                });
            ...
            modelBuilder.Entity("OrderChina.Shared.Domain.Orders.MainOrderShopCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_main_order_shop_codes");
            ...
            modelBuilder.Entity("OrderChina.Shared.Domain.Orders.OrderShopTemp", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_order_shop_temps");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_order_shop_temps_user_id");

                    b.ToTable("order_shop_temps", (string)null);
                });

            modelBuilder.Entity("OrderChina.Shared.Domain.Orders.ProductTemp", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("OrderShopTempId")
                        .HasColumnType("uuid")
                        .HasColumnName("order_shop_temp_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_product_temps");

                    b.HasIndex("OrderShopTempId")
                        .HasDatabaseName("ix_product_temps_order_shop_temp_id");

                    b.ToTable("product_temps", (string)null);
                });
            ...
            modelBuilder.Entity("OrderChina.Shared.Domain.Orders.TrackingCode", b =>
                {
                    ...
                    b.Property<Guid?>("ArrivedChinaWarehouseByUserId")
                        .HasColumnType("uuid")
                        .HasColumnName("arrived_china_warehouse_by_user_id");

                    b.Property<DateTime?>("ArrivedVietnamWarehouseAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("arrived_vietnam_warehouse_at_utc");

                    b.Property<Guid?>("ArrivedVietnamWarehouseByUserId")
                        .HasColumnType("uuid")
                        .HasColumnName("arrived_vietnam_warehouse_by_user_id");
                    ...
                    b.Property<Guid?>("DeliveredToCustomerByUserId")
                        .HasColumnType("uuid")
                        .HasColumnName("delivered_to_customer_by_user_id");
                    ...
                    b.Property<Guid?>("InTransitToVietnamByUserId")
                        .HasColumnType("uuid")
                        .HasColumnName("in_transit_to_vietnam_by_user_id");
            ...
            modelBuilder.Entity("OrderChina.Shared.Domain.Orders.ProductTemp", b =>
                {
                    b.HasOne("OrderChina.Shared.Domain.Orders.OrderShopTemp", null)
                        .WithMany("Products")
                        .HasForeignKey("OrderShopTempId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_product_temps_order_shop_temps_order_shop_temp_id");
                });
